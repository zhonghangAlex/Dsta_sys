  ...
  <div class="main_con">
    <div class="pad_con">
      ...
      <el-table :data="question" fit  highlight-current-row :border="border" v-loading="listLoading" @selection-change="selsChange" style="width: 100%;margin-bottom:15px;" class="tablelist">
        ...
        <el-table-column fixed="right" label="操作" width="150" align="center">
          <template slot-scope="scope"><!--<template scope="scope">-->
            ...
            <el-button type="danger" size="small" @click="handleDel(scope.$index, scope.row)">取消收藏</el-button>
          </template>
        </el-table-column>
      </el-table>
      ...
      <el-col :span="24" class="toolbar">
        <el-button type="danger" @click="batchRemove" :disabled="this.sels.length===0">批量取消收藏</el-button>
...
<script>
  ...
  import { GetCollectInfo,  CancelCollect } from "../../api/api";
  export default {
    data() {
      return {
        //权限
    ...
    methods: {
      ...
      getquestions(x) {
        ...
        GetCollectInfo(params).then((response)=>{
