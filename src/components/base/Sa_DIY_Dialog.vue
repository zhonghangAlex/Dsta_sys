<template>
  <el-dialog
    ...
    <div class="sa_con">
      <div id="sa_app" >
        <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" background-color="#44a0b3" text-color="#fff" active-text-color="#ffd04b">
        ...
        <!-- 输入区域 -->
        <div style="padding:5px; border:1px dashed #FBC638; border-radius:10px; margin:10px;">
        ...
        <div style="padding:5px; border:1px dashed #FBC638; border-radius:10px; margin:10px;">
          ...
          <el-button type="primary" class="start_run_ord" @click="run_code">执行命令</el-button>
