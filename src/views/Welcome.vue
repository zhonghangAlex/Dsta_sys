          ...
          <div class="lowin-box-inner">
            <div>
              ...
              <div class="lowin-group">
                <label>邮箱 <a href="#" class="login-back-link">直接登录?</a></label>
                <input type="email" autocomplete="email" name="email" class="lowin-input email_ipt">
              </div>
              <div class="lowin-group password-group">
                <label>密码 <a href="#" class="forgot-link">忘记密码了吗?</a></label>
                <input type="password" name="password" autocomplete="current-password" class="lowin-input password_ipt">
              </div>
              <button class="lowin-btn login-btn" @click="userLogin">
                登&nbsp;&nbsp;&nbsp;录
              </button>

              <div class="text-foot">
                还没有一个账号吗? <a href="" class="register-link">注册</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="lowin-box lowin-register">
          <div class="lowin-box-inner">
            <div>
              ...
              <div class="text-foot">
                已经拥有一个账号? <a href="" class="login-link">登录</a>
              </div>
            </div>
          </div>
        </div>
